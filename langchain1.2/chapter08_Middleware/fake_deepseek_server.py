    ...
    def do_POST(self):
                        ...
                        "tool_calls": [
                            {
                                ...
                                "function": {
                                    ...
                                    "arguments": json.dumps(
                                        {'name': '田中', 'email': 'songhongkang@atguigu.cn', 'phone': '12345678912'},
                                        ensure_ascii=False
                                    )
                                }
                            }
        ...
        append_val = {
            ...
            "function": {
                ...
                "arguments": json.dumps(
                    {'event_name': 'プロジェクトキックオフミーティング', 'date': '2026-03-27'},
                    ensure_ascii=False
                )
            }
        }
        ...
        #     {'name1': '田中', 'email2': 'songhongkang@atguigu.cn', 'phone': '12345678912'},
        #     ensure_ascii=False
        # )
